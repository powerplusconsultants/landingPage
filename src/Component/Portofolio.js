...
import Ciputra from "./../assets/ciputra2.png";
    ...
    return (
        <div className="container mt-5" id="stage">
            ...
            <div className="row mt-3">
                ...
                <div className="col-lg-3 col-md-6">
                    <CardPorto src={UBMImage} title="Universitas Bunda Mulia" text={"Universitas Bunda Mulia Housing <br /> Ancol, Jakarta (12th Storey)"}/>
                </div>
            </div>
            <div className="row mt-3 justify-content-center">
                <div className="col-lg-3 col-md-6">
                    <CardPorto src={ChruchImage} title="Gereja Graha Victory" text={"Gereja Graha Victory <br /> Surabaya (7th Storey)"}/>
                </div>
                <div className="col-lg-3 col-md-6">
                    <CardPorto src={MiningImage} title="Tambang Pasir Silika" text={`PT. Karya Emas Multisani <br /> Tambang Pasir Silika – East Belitung`}/>
                </div>
                <div className="col-lg-3 col-md-6">
                    <CardPorto src={WhsImage} title="Toko dan Gudang" text={`Toko dan Gudang Dupak <br /> Surabaya (5th Storey)`}/>
                </div>
                <div className="col-lg-3 col-md-6">
            ...
            <div className="row mt-3 justify-content-center">
                <div className="col-lg-3 col-md-6">
                    <CardPorto src={Ciputra} title="Ciputra Sport Center" text={"Citraland Surabaya <br /> Project Ciputra Sport Center"}/>
                </div>
            </div>
        </div>
    )
